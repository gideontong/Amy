...
class Internet {
    ...
    static doRequest(options, toExecute) {
        ...
        var req = https.request(options, function (res) {
            if (res.statusCode === 301 || res.statusCode === 302) {
                return Internet.doRequest(res.headers.location, toExecute);
            }
     ...
     */
    static getRedditImage(subreddits, attempts = 0) {
        try {
            if (attempts > 5) {
                return 'Error: failed too many times trying to get an image!';
            }
            ...
            if (typeof (subreddits) == 'string') {
                ...
                return 'Error: something strange happened!';
            }
            ...
            Internet.authenticatedGet(function (data) {
                if (data
                    ...
                    if (link.startsWith('https://i.')) {
                        ...
                        return `This link isn't supported yet, but you can view it in the browser: ${link}`;
                    }
                } else {
            ...
            return 'Error: crashed while trying to get an image!';
        }
    }
}
